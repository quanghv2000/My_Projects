...
import RoomCategoryUpdate from 'app/pages/admin/admin-room-category-management-page/base/room-category-update/index';
import Moment from 'react-moment';

const RoomCategoryView = (props) => {
  const handleOk = () => {
  ...
  return (
    <>
      ...
      />
      <Modal
        title={'Danh mục phòng: ' + props?.data?.name}
      ...
      >
        <div style={{ display: 'flex' }}>
          ...
          <div style={{ maxWidth: '50%' }}>
            <p>
              <strong>Danh mục phòng: </strong> {props?.data?.name}
            </p>
