...
const houseCategories = [
  ...
  },
  {
    ...
    key: 'description',
    render: (description) => convertRoomTypeDescription(description),
  },
  {
    title: 'Ngày tạo',
...
export const HouseCategoryList: React.FC<any> = () => {
  ...
  const accounts = [
    {
      id: 1,
      name: 'Nhà trọ chung chủ',
      description:
        'Loại phòng này rất thích hợp với người thích sự riêng tự, yên tĩnh',
      createdDate: new Date(),
      createdBy: 'quanghv7',
    },
    {
      id: 2,
      name: 'Dãy nhà trọ tự quản lý',
      description:
        'Loại phòng này rất thích hợp với những người thích ở chung, giá cả sẽ rẻ hơn khi ở chung',
      createdDate: new Date(),
      createdBy: 'quanghv7',
    },
    {
      ...
      name: 'Chung cư',
      description:
        'Loại phòng dành cho việc giải quyết nhu cầu về chỗ ở, tá túc cho các sinh viên của các trường đại học, cao đẳng',
      createdDate: new Date(),
      createdBy: 'quanghv7',
    },
    {
      ...
      name: 'Chung cư mini',
      description:
        'Giá cả phải chăng, căn hộ chung cư mini thường phù hợp với sinh viên, người lao động, người có thu nhập trung bình, thấp.',
      createdDate: new Date(),
      createdBy: 'quanghv7',
    },
    {
  ...
  return (
    <Fragment>
      ...
      >
        <div>
          <strong>Tổng số loại hình cho thuê: 6</strong>
        </div>
        <div>
          <Button
            className="ml-20"
