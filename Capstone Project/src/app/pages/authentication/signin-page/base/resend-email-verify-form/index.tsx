...
import { resendEmailVerifyRequest } from 'app/pages/authentication/signin-page/screen/action';
...
export const ResendEmailVerifyForm = ({
  visibleModal,
  handleOk,
  handleCancel,
  ...
  const onFinishFormEmail = (values: any) => {
    dispatch(resendEmailVerifyRequest(values?.email));
  };
    ...
    <Fragment>
      <Row className="modal-container">
        <Modal
          ...
          confirmLoading={state?.loadingResendEmail}
          onOk={handleOk}
