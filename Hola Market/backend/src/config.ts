...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8081';
  'jhipster.clientApp.name' = 'nhipster_server';
  ...
  'jhipster.mail.from' = 'nhipster_server@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'nhipster_server API';
  'jhipster.swagger.description' = 'nhipster_server API documentation';
  ...
  'eureka.instance.appname' = 'nhipster_server';
  'eureka.instance.instanceId' = 'nhipster_server:${random.value}';
  ...
  'cloud.config.name' = 'nhipster_server';
